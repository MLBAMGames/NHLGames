...
Namespace Utilities
    Public Class ImageFetcher
        Public Shared Function GetEmbeddedImage(fileName As String) As Image
            ...
            Using s As Stream = myAssembly.GetManifestResourceStream($"NHLGames.{fileName.ToLower()}.png")
